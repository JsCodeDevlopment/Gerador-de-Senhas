  ...
  return (
    <div className="flex flex-col bg-zinc-950 w-full items-center gap-5 justify-center h-screen">
      ...
      <div className="flex gap-12">
        <button className="bg-purple-950 text-white p-2 rounded-md" onClick={GenerateKey}>Gerar!</button>
        <button className="bg-purple-950 text-white p-2 rounded-md" onClick={Copy}>{copied}</button>
      </div>
